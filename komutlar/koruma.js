...
if (!logk) return message.channel.send('Güvenlik kanalını bulamadım  Kullanım `!ögüvenlik #kanal`');
 

   db.set(`guvenlik${message.guild.id}`, logk.id)

message.channel.send(` :file_folder: Güvenlik başarıyla ${logk} olarak ayarlandı artık dosyaları burda saklıyacağım`);
...
module.exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['ögüvenlik','güvenlik'],
  permLevel: 4
};

module.exports.help = {
  name: 'ögüvenlik',
  description: 'ögüvenlik sağlar',
  usage: 'ögüvenlik'
};