...
exports.run = async (bot, message, args) =>
{
  ...
  if (!mentionedChannel && args[0] !== "sıfırla") return message.channel.send("Ayarlamam için Bir Rol Etiketlemelisin. \nRolü Etiketleyemiyorsan **Rolün Etiketleme Seçenenini Aktif Etmeyi Unutma** \nörnek Kullanım : !otorol @rol #kanal \n**Oto Yazı Kapatmak istiyorsan !kapat otoyazı**");
