...
exports.run = (client, message, args) => {
  ...
  if (!user) return message.reply('**Lütfen kime rol vereceğimi yazınız !**kullanım !rol-ver @kişi @rol  ').catch(console.error);
  if (rol.length < 1) return message.reply('** Vereceğim Rolü etiketleyin lütfen :zap: *');
user.addRole(rol);
